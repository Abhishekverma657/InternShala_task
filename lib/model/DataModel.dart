...
class InternshipsMeta {
  ...
  factory InternshipsMeta.fromJson(Map<String, dynamic> json) => InternshipsMeta(
    ...
    jobSegments: List<Segment>.from(json["job_segments"].map((x) => segmentValues.map[x]!)),
    ...
    labelsAppInCard: List<LabelsAppElement>.from(json["labels_app_in_card"].map((x) => labelsAppElementValues.map[x]!)),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "job_segments": List<dynamic>.from(jobSegments.map((x) => segmentValues.reverse[x])),
    ...
    "labels_app_in_card": List<dynamic>.from(labelsAppInCard.map((x) => labelsAppElementValues.reverse[x])),
...
class LabelElement {
  ...
  factory LabelElement.fromJson(Map<String, dynamic> json) => LabelElement(
    labelValue: List<LabelsAppElement>.from(json["label_value"].map((x) => labelsAppElementValues.map[x]!)),
    labelMobile: List<LabelsAppElement>.from(json["label_mobile"].map((x) => labelsAppElementValues.map[x]!)),
    labelApp: List<LabelsAppElement>.from(json["label_app"].map((x) => labelsAppElementValues.map[x]!)),
    labelsAppInCard: List<LabelsAppElement>.from(json["labels_app_in_card"].map((x) => labelsAppElementValues.map[x]!)),
  );

  Map<String, dynamic> toJson() => {
    "label_value": List<dynamic>.from(labelValue.map((x) => labelsAppElementValues.reverse[x])),
    "label_mobile": List<dynamic>.from(labelMobile.map((x) => labelsAppElementValues.reverse[x])),
    "label_app": List<dynamic>.from(labelApp.map((x) => labelsAppElementValues.reverse[x])),
    "labels_app_in_card": List<dynamic>.from(labelsAppInCard.map((x) => labelsAppElementValues.reverse[x])),
  };
}
