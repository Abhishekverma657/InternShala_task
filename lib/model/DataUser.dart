...
class InternshipsMeta {
  ...
  final List<Segment>? jobSegments;
  ...
  final List<LabelsAppElement>? labelsAppInCard;
...
class LabelElement {
  final List<LabelsAppElement>? labelValue;
  final List<LabelsAppElement>? labelMobile;
  final List<LabelsAppElement>? labelApp;
  final List<LabelsAppElement>? labelsAppInCard;
